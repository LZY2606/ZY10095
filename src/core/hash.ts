/**
 * Deterministic canonical JSON: object keys are sorted and keys with undefined
 * values are omitted. Traversal order therefore never affects output.
 */
...
/** Pure SHA-256 (FIPS 180-4), no native crypto dependency. */
...
function sha256Bytes(data: Uint8Array): string {
  ...
  // bit length mod 2^64 (inputs here are always < 512 MiB, high word stays 0)
